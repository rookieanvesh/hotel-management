...
const RoomSearch = ({ handleSearchResult }) => {
  ...
  /**THis is going to be used to fetch availabe rooms from database base on search data that'll be passed in */
    ...
    <section>
      <div className="search-container">
        ...
        <div className="search-field">
          ...
          <select value={roomType} onChange={(e) => setRoomType(e.target.value)} className="select-field">
